-- =============================================================
-- Philipeia — Script completo de criação do banco
-- Executar no SSMS conectado ao SQL Server
-- =============================================================

-- -------------------------------------------------------------
-- 1. Criar banco (ignorar se já existir)
-- -------------------------------------------------------------
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = 'philipeia')
BEGIN
...
-- 4. style_volumes
-- -------------------------------------------------------------
IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='style_volumes' AND xtype='U')
BEGIN
...
PRINT '================================================';
PRINT 'Script concluído. Banco philipeia pronto.';
PRINT 'Execute inserts.sql para popular dados iniciais.';
PRINT '================================================';
